...
public class PanelInvoicesCreating extends UtilsFacturacion implements ActionListener, ItemListener {
	...
	/**
	 * Método que suministra el panel de factura con sus componentes.
	 * 
	...
	public JPanel makeInvoice(JFrame mainFrame) {
		...
		// titulo
		JLabel title=new JLabel("                          FACTURACIÓN - CREACIÓN                      ");
		title.setFont(font1);
		...
		marcoAux01.add(new JLabel("código"));
		...
		marcoAux1.add(new JLabel("VISUALIZACIÓN ÚLTIMOS APUNTES"));
		marcoAux1.add(new JLabel(" "));		
	 ...
	 * error, devuelve un false, e ilumina la casilla del formulario de creación facturas.
	 * 
	...
	private void createHelp () {
		...
		JTextArea hText=new JTextArea(
				"1.- Primeramente deberá seleccionar un cliente para facturar.\n" +
				"2.- Introduzca la fecha de la factura, en formato dd-mm-aaaa.\n" +
				"3.- El sistema facilita el siguiente número de factura. Si lo desea, puede modificarlo\n" +
				"    para introducir facturas en número que haya dado de baja, o si desea tener otra\n" +
				"    serie de facturación distinta a la principal.\n" +
				"    Por defecto, el sistema recordará el último número de factura mientras la aplica\n" +
				"    ción esté abierta. Puede cambiar el último número de factura en Administración-\n" +
				"    Empresas. Deberá reiniciar para que el cambio surta efecto.\n" +
				"4.- Los datos se introducen en la zona de 'Introducción de datos'. Si desea facturar\n" +
				"    un albarán ya creado, seleccionelo en el desplegable 'codigo'. Si va a grabar\n" +
				...
				"    botón 'intro' para aceptar la entrada.\n" +
				...
				"    trarán los 5 últimos en pantalla.\n" +
				"5.- Si lo desea puede borrar los 5 últimos apuntes pulsando en el botón 'X' al lado\n" +
				"    del apunte a borrar. Si tiene más de 5 apuntes grabados, se mostrará en pantalla el\n" +
				"    siguiente apunte y así sucesivamente.\n" +
				"6.- Si desea borrar todos los datos introducidos, pulse en el botón Borrar datos.\n" +
				"7.- Cuando tenga confeccionada la factura, pulse el botón 'Grabar factura'. La aplicación\n" +
				"    le pedirá la confirmación. En caso afirmativo, La factura habrá quedado grabada.\n" +
				"    A continuación, la aplicación le preguntará si desea imprimir la factura en formato\n" +
				"    PDF. En caso afirmativo se generará un PDF que quedará grabado en donde tenga\n" +
				"    instalada la aplicación. El PDF no se mostrará automáticamente en pantalla.\n");
		hText.setForeground(COLORL);
		hText.setEditable(false);
		panelText.add(hText);
		
		JPanel title=new JPanel();
		title.add(new JLabel("AYUDA DE CREACIÓN FACTURAS"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source.equals("Grabar factura")) {	
			...
			if (checkFinalForm()) {
				...
				if (JOptionPane.showConfirmDialog(mainFrame, "¿Desea grabar la factura que ha introducido en el formulario?", "Grabación de la factura", JOptionPane.YES_NO_OPTION)==0) {
					...
					if (facturador.createInvoice(datosF)) {
						...
						for (String a[]:datosFact) {
							if (!a[0].equals(CODEDIRECT)) {
								...
								if (!albaranes.changeToInvoicedState(a[0], numFact)) {
									JOptionPane.showMessageDialog(mainFrame, "Error dando de baja albarán",
											"Grabación de facturas",JOptionPane.WARNING_MESSAGE);
								}
							}
						}
						...
						try {
							...
							// do nothing
							System.err.println("ERROR: "+numbIv+" no es posible transformar en número");
						}
						...
						JOptionPane.showMessageDialog(mainFrame, "Error en grabación de factura","Grabación de facturas",JOptionPane.ERROR_MESSAGE);
					}
				...
				JOptionPane.showMessageDialog(mainFrame, "No es posible grabar la factura:\n" +
						"Datos incorrectos o formulario incompleto.","Grabación de facturas",JOptionPane.ERROR_MESSAGE);
			}
